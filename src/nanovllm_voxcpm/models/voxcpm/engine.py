...
from src.nanovllm_voxcpm.models.voxcpm.runner import VoxCPMRunner, RunnerTask, VoxCPMPayload
from src.nanovllm_voxcpm.config import Config
from src.nanovllm_voxcpm.models.voxcpm.config import VoxCPMConfig
from src.nanovllm_voxcpm.models.voxcpm.lora_loader import load_voxcpm_lora_checkpoint
from src.nanovllm_voxcpm.engine.sequence import Sequence
from dataclasses import dataclass
import numpy as np
from transformers import LlamaTokenizerFast
from src.nanovllm_voxcpm.models.voxcpm.utils import mask_multichar_chinese_tokens
import torch
...
class VoxCPMEngine(LLMEngineBase):
    ...
    def register_lora(self, name: str, path: str) -> int:
        payload = load_voxcpm_lora_checkpoint(path, tp_size=self.model_runner.world_size)
