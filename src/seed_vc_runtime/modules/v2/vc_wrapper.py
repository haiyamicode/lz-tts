...
class VoiceConversionWrapper(torch.nn.Module):
    ...
    def load_checkpoints(
        ...
        # cfm
        cfm_checkpoint = torch.load(cfm_checkpoint_path, map_location="cpu", weights_only=False)
        ...
        # ar
        ar_checkpoint = torch.load(ar_checkpoint_path, map_location="cpu", weights_only=False)
        ...
        content_extractor_narrow_checkpoint = torch.load(content_extractor_narrow_checkpoint_path, map_location="cpu", weights_only=False)
        ...
        content_extractor_wide_checkpoint = torch.load(content_extractor_wide_checkpoint_path, map_location="cpu", weights_only=False)
        ...
        style_encoder_checkpoint = torch.load(style_encoder_checkpoint_path, map_location="cpu", weights_only=False)
