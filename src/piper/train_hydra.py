...
_DEFAULTS: dict[str, Any] = {
    ...
    "training_sampler_alpha": None,
    "validation_split": 0.1,
    "validation_split_mode": "contiguous",
    "num_test_examples": 5,
    ...
    "utmos_noise_w": 0.8,
    "utmos_sdp_ratio": 0.2,
    "scoreq_enabled": False,
    "scoreq_every_n_epochs": 10,
    "scoreq_num_samples": 10,
    "scoreq_output_dir": None,
    "scoreq_python": ".venv/bin/python",
    "scoreq_script": "scripts/score_dpo_scoreq_windows.py",
    "scoreq_model": None,
    "scoreq_window_seconds": 0.75,
    "scoreq_hop_ratio": 0.25,
    "scoreq_min_threshold": 3.5,
    "scoreq_mean_threshold": 3.7,
    "scoreq_cpu_threads": 16,
    "scoreq_noise_scale": 0.667,
    "scoreq_length_scale": 1.0,
    "scoreq_noise_w": 0.8,
    "scoreq_sdp_ratio": 0.2,
    "seed": 1234,
}
